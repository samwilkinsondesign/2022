...
Promise.all([
    (0, _utils.preloadImages)('.item__img, .content__img'),
    (0, _utils.preloadFonts)('ytb6dpl')
]).then(()=>{
    ...
    ].forEach((item)=>itemsArr.push(new (0, _item.Item)(item, itemsArr)));
    // mouse effects on all links and others
    [
        ...document.querySelectorAll('a, .unbutton')
    ].forEach((link)=>{
...
html.onclick = function(event) {
    if (event.target === html) html.classList.remove('active');
};

},{"./utils":"bMpAD","./cursor":"czxmt","./item":"8HgfV"}],"bMpAD":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "wrapElements", ()=>wrapElements);
...
},{"gsap":"9F7Z6","./utils":"bMpAD","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9F7Z6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8HgfV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Item {
    constructor(el, itemsArr){
        ...
        (0, _gsap.gsap).set(this.DOM.enterActionSVGCircle, {
            transformOrigin: '50% 50%'
        });
        // the circle magnetic functionality
        this.magneticFx = new (0, _magneticFx.MagneticFx)(this.DOM.enterAction);
        ...
        this.DOM.metaContent = [
            ...this.DOM.el.querySelectorAll('.item__meta > .item__meta-row')
        ];
    ...
    editHeadingLayout() {
        ...
        this.DOM.itemHeadingChars = [
            ...this.DOM.heading.querySelectorAll('.char')
        ];
    ...
    editContentLayout() {
        ...
        this.DOM.contentHeadingChars = [
            ...this.DOM.contentElHeading.querySelectorAll('.char')
        ];
        (0, _utils.wrapElements)(this.DOM.contentHeadingChars, 'span', 'char-wrap');
        this.DOM.contentElText = [
            ...this.DOM.contentEl.querySelectorAll('.content__text > *')
        ];
    }
    initEvents() {
    ...
    onMouseEnter() {
        ...
        this.timelineHoverIn = (0, _gsap.gsap).timeline().addLabel('start', 0).to(this.DOM.enterActionSVGCircle, {
            duration: 0.8,
            ease: 'power3',
            scale: 1.1
    ...
    onMouseLeave() {
        ...
        this.timelineHoverOut = (0, _gsap.gsap).timeline().addLabel('start', 0).to(this.DOM.enterAction, {
            duration: 0.8,
            ease: 'power3',
            x: 0,
            y: 0
    ...
    open() {
        ...
        this.timelineHoverOpen = (0, _gsap.gsap).timeline().addLabel('start', 0)// set up some content elements before the animation starts
        ...
        .to([
            frameEl,
            this.itemsArr.filter((item)=>item != this).map((item)=>item.DOM.el)
        ], {
            duration: 0.6,
            ease: 'power3',
            opacity: 0
        ...
        .to(this.DOM.enterActionSVGCircle, {
            ...
            scale: 2.3,
            opacity: 0,
            onComplete: ()=>(0, _gsap.gsap).set(this.DOM.enterAction, {
                    x: 0,
                    y: 0
                })
    ...
    close() {
        ...
        this.timelineHoverClose = (0, _gsap.gsap).timeline().addLabel('start', 0).set(this.DOM.enterAction, {
            x: 0,
            y: 0
...
},{"gsap":"9F7Z6","./magneticFx":"eKKhI","./utils":"bMpAD","gsap/gsap-core":"evdHe","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"6m3bh","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eKKhI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"gsap":"9F7Z6","./utils":"bMpAD","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3uR7n":[function() {},{}],"7jeGL":[function() {},{}],"6m3bh":[function(require,module,exports,__globalThis) {
